...
public abstract class Entity {
	...
	private static Shape defaultShape = new Ellipse2D.Double(-10, -10, 20, 20);
	 ...
	 * @see {@linkplain Entity.RotationMode}
	 */
	...
	/**
	 * The {@linkplain Shape} of this {@linkplain Entity} which is used for collisions, and, if no {@linkplain
	 * Entity#image image} is set, drawing to the {@linkplain World}
	 ...
	 * @see {@linkplain Entity#shape shape},
	 * {@linkplain Entity#color color},
	 * {@linkplain Entity#fill fill},
	 * {@linkplain Entity#lineWidth lineWidth},
	 * {@linkplain Entity#x x},
	 * {@linkplain Entity#y y},
	 * {@linkplain Entity#rotation rotation},
	 * {@linkplain Entity#rotationMode rotationMode}
	 */
	public abstract void setup();
	
	/**
	 * This method is called every time the {@linkplain World} updates, based on it's specified {@linkplain
	 * World#setFramerate(double) framerate}. All game logic, like movement or combat, should be implemented here.
	 */
	 ...
	 * {@linkplain World}, including it's position and rotation, depending on the {@linkplain Entity#rotationMode
